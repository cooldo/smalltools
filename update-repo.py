...
# get repo name
#myText = browser.find_element_by_xpath("/html/body/gr-app/main/gr-change-view/div[2]/section[1]/div[1]/gr-change-metadata/gr-external-style/section[9]/span[2]/a/gr-limited-text")
#repo = myText.text.split('/')[-1]
...
with open('update-repo.sh', 'w') as f:
	...
	f.write('#THIS FILE IS AUTOMATICALLY GENERATED, DON\'T MODIFY IT UNLESS YOU HAVE ENOUGH CONFIDENCE\n')
	for key in dict:
		LEN = len(dict[key])
		if LEN > 2:
